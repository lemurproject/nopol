...
public class AsciiFolder {
    ...
    public static String foldToAscii(String input){
        char[] output = foldToASCII(input.toCharArray(), input.length());
    ...
    public static char[] foldToASCII(char[] input, int length) {
        ...
        int outputLength = foldToASCII(input, 0, output, 0, length);
     ...
     * @lucene.internal
     */
    public static final int foldToASCII(char input[], int inputPos, char output[],
            int outputPos, int length) {
