...
public class EncodingDetector {
 ...
 private final Logger logger = LoggerFactory.getLogger(EncodingDetector.class);
 ...
 public EncodingDetector(final StreamEncodingDetector streamEncodingDetector) throws IOException {
     this(streamEncodingDetector,ISO_8859_1);
 }

 public EncodingDetector(final StreamEncodingDetector streamEncodingDetector, final String alternativePreliminaryEncoding) throws IOException {
 ...
 public EncodingDetector(final InputStream inputStream, final String preliminaryEncoding, final String preliminaryEncodingSpecificationInfo, final String alternativePreliminaryEncoding) throws IOException {
 ...
 private boolean detectDocumentSpecifiedEncoding() throws IOException {
     ...
     //FIXME
     final String documentSpecifiedEncoding=EncDetUils.getDocumentSpecifiedEncoding(previewSource, this);
 ...
 private Source getPreviewSource(final String previewEncoding) throws IOException {
     ...
     return new Source(new String(bytes,previewEncoding));
 }
