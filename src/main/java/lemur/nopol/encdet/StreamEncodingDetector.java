...
*/
public class StreamEncodingDetector {
 ...
 private final Logger logger = LoggerFactory.getLogger(StreamEncodingDetector.class);
 ...
 private static final String DEFAULT_8BIT=EncDetUils.isEncodingSupported(WINDOWS_1252)?WINDOWS_1252:ISO_8859_1;
